...
%             channel_mat
            ...
            beamf_antenna_state = analog_beamf_config_choser(beamform_mat_all_users,num_ant,ants_to_use,pi/3);
    ...
    %             save(path_dir+"rx_samps_"+expmt_mode_str+"_null"+"_"+num2str(expmt_id)+".mat",'raw_rx_samps_null');
        ...
        elseif(expmt_mode_str=="fdma")
            ...
            for chan_idx=1:1:numel(chan_list)
                raw_rx_samps = get_rx_samps_warp(antenna_state,25, 2,chan_list(chan_idx));
