function syms_eq_mat = rx_equalize_signal_siso(rx_vec_cfo_corr,lts_ind,rx_H_est,param)
...
rx_pkt_range = lts_ind+(param.NUM_LTS+0.5)*param.N_SC+param.inter_user_zeros:lts_ind+(param.NUM_LTS+0.5)*param.N_SC+param.inter_user_zeros+tx_num_origsamp-1;
