...
if(~unsynch)
    ...
    if(isempty(lts_last_user_index))
        ...
        return;
%     else
%         fprintf("Multi user LTS working fine");
    end
...
%     lts_range_possibilities = ((params.NUM_LTS+0.5)*params.N_SC+params.inter_user_zeros)*(params.num_users)+params.inter_user_zeros;
    lts_range_possibilities_oneuser_min = ((params.NUM_LTS+0.5)*params.N_SC+params.inter_user_zeros)-params.inter_user_zeros*0.5;
    lts_range_possibilities_oneuser_max = ((params.NUM_LTS+0.5)*params.N_SC+params.inter_user_zeros)+params.inter_user_zeros*0.5;
