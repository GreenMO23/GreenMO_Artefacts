...
class x300_twinrx_2(gr.top_block):

    def __init__(self,test_id,test_str):
        gr.top_block.__init__(self, "X300 Twinrx 2")
...
def main(top_block_cls=x300_twinrx_2, options=None):
    ...
    sav_dir = "/home/wcsng-20/ag_data/"+test_str+"_"+date_str+"_"+str(folder_id)+"/"
