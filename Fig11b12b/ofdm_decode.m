function [op_struct, params] = ofdm_decode(rx_vec_air, tx_params, params, user_index)
...
%   Contributors: Ish Jain, Raghav Subbaraman
    ...
    rx_pkt_and_preamble_range = 1:(1+((params.NUM_LTS+0.5)*params.N_SC+params.inter_user_zeros)*params.num_users+tx_num_origsamp-1);
    raw_rx_dec_iter = rx_vec_air(rx_pkt_and_preamble_range);
    [rx_H_est,rx_vec_cfo_corr,params]= extractChannel_singuser(raw_rx_dec_iter,params,user_index); 
    ...
    %% Rx Payload
    syms_eq_mat = rx_equalize_signal(rx_vec_cfo_corr,rx_H_est,params);
